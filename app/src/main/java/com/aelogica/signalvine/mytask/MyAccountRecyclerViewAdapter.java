...
public class MyAccountRecyclerViewAdapter extends RecyclerView.Adapter<MyAccountRecyclerViewAdapter.ViewHolder> {
    ...
    private final AccountFragment.OnListFragmentInteractionListener mListener;

    public MyAccountRecyclerViewAdapter(List<AccountItem> items, AccountFragment.OnListFragmentInteractionListener listener) {
        mValues = items;
        mListener = listener;
    }
